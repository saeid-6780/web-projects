...
<style>
    ...
    .row2 {width: 100%;float: right;margin-top: 10px;margin-bottom: 10px;font-size: 10.5pt;font-family: byekan;}
...
<div id="main" style="width: 1200px;margin:10px auto;padding: 10px;background: #fff;">

    <form action="checkout/creditcard/<?= $orderinfo['id'] ?>" method="post">
        <div class="row2"><h3>اطلاعات واریز کارت به کارت</h3></div>
        <div class="row2">
        ...
        <div class="row2">
            <span class="title w120">ساعت واریز:</span>
        ...
        <div class="row2">
            <a class="btn_green" onclick="submintform()">
                ثبت اطلاعات
            </a>
        </div>
    </form>

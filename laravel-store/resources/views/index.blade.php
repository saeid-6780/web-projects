...
@section('page-content')
	...
	<div class="container margin_60_35">
		...
		<div class="row">
			...
			@foreach($last_blog_post as $blog_post)
				<div class="col-lg-6">
					<a class="box_news" href="blog/{{$blog_post->slug_fa}}">
						<figure>
						...
						<ul>
							...
							<li>{{$blog_post->jdate}}</li>
						</ul>
						<h4>{{$blog_post->title}}</h4>
						<p><?= substr($blog_post->description,0,50) ?>....</p>
					</a>
				</div>
			@endforeach

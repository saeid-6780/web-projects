...
<head>
	...
	<title>cakaneh - @stack('page-title')</title>
	...
	<!--<link href="<?/*= \Illuminate\Support\Facades\URL::asset('css/bootstrap.custom.min.css') */?>" rel="stylesheet">-->
								...
								<div class="dropdown dropdown-access">
									...
									<div class="dropdown-menu">
											...
											<form action="{{route('logout')}}" method="post">
												@csrf
												<button class="btn_1" type="submit">logout</button>
											</form>
											@endauth
